...
class marcacoesNaoAceitesAdmin extends Component {
  ...
  async componentDidMount() {
    ...
    const response = await axios.get(
        "https://localhost:7067/api/Marcacoes/NaoAceites"
    );
  ...
  render(){
    ...
    return (
      <div class="displayInfo" >
        <h1> Lista de Marcações Não Aceites </h1>
...
export default marcacoesNaoAceitesAdmin;
