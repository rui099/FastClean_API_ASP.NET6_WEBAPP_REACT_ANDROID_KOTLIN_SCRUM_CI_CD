...
class marcacoesTerminadasAdmin extends Component {
  ...
  async componentDidMount() {
    ...
    const response = await axios.get(
        "https://localhost:7067/api/Marcacoes/Terminadas"
    );
  ...
  render(){
    ...
    return (
      <div class="displayInfo" >
        <h1> Lista de Marcações Terminadas </h1>
...
export default marcacoesTerminadasAdmin;
