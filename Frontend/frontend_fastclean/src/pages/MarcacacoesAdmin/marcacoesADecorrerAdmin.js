...
class marcacoesADecorrerAdmin extends Component {
  ...
  async componentDidMount() {
    ...
    const response = await axios.get(
        "https://localhost:7067/api/Marcacoes/ADecorrer"
    );
  ...
  render(){
    ...
    return (
      <div class="displayInfo" >
        <h1> Lista de Marcações A Decorrer </h1>
...
export default marcacoesADecorrerAdmin;
