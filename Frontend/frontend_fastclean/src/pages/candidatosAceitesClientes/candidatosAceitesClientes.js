...
import './candidatosAceitesClientes.css';
...
import {NavIcon } from './candidatosAceitesClientesElements';
...
function refresh() {
  ...
  class usersAceitesClientes extends Component {
    ...
    async componentDidMount() {
      ...
      if(getCargo() === "Administrador") {
        ...
        const response = await axios.get(
            "https://localhost:7067/api/Clientes/ClienteAceites"
        );
    ...
    render(){
      ...
      return (
         ...
         <div class="displayInfo" >
            <h1> Candidatos Aceites (Clientes) </h1>
    
            <div class="filtroDiv4">
              <form style={{width: 750}} onSubmit={this.filtrar}>
                <label style={{fontSize: "medium"}} >Pesquise por Email: </label>
                <input class="emailInp4" type="email" name="email" placeholder= "abc@gmail.com" onChange={e => this.setState({ email: e.target.value })} />
...
export default usersAceitesClientes;