 ...
 * Use the [RegisterClientFilesFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RegisterClientFilesFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_register_client_files, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment RegisterClientFilesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RegisterClientFilesFragment().apply {
